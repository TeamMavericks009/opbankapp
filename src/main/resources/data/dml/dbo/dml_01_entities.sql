...
select user_id as user_login_id, coalesce(email, phone_number) as user_id, crypt(first_name||right(phone_number,4), gen_salt('bf')), current_date-2,'182.189.12.53' , concat(first_name||' ', last_name) as user_name
  from dbo.users;
